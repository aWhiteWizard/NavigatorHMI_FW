...
# 2026-08-14 NavigatorHMI: glibc 2.41-70 (Rockchip fork 开发版) 在 aarch64 上
# 链接 ld.so 时 undefined reference '__lll_lock_wake_private' (源码缺失该符号,
# 2.41 新增锁机制不完整) —— 切到 2.38 (buildroot 标准版, dl 缓存已有, 成熟稳定)
