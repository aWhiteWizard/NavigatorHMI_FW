...
# 2026-08-15 NavigatorHMI: 跳过 terminfo 精简 (外部工具链 + ncurses 6.4 场景)
# ncurses 6.4 的 make sources 生成 hash 数字布局 terminfo (如 31/1178),
# 而本 cleanup 期望字母布局 (a/ansi) -> 复制失败; target 已装完整 terminfo
# (1814 entries), 跳过精简 (多占少量空间但功能完整)
