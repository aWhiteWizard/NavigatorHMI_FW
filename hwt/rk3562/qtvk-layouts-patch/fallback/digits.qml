...
KeyboardLayout {
    ...
    KeyboardColumn {
        ...
        KeyboardRow {
            // F 循环(2026-08-23 NavigatorHMI): 数字键盘地球键去掉 customLayoutsOnly——
            // 否则仅在有自定义布局的语言间切换, zh_CN/en_US 均 fallback → 点击无反应;
            // 去掉后点击在 activeLocales 全列表循环切换(languagePopupListEnabled=false)
            ChangeLanguageKey {
            }
            Key {
                key: Qt.Key_0
